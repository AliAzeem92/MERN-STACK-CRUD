...
const User = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-blue-500 via-blue-200 to-blue-500 flex items-center justify-center p-4">
      <Toaster />
            ...
            <table className="min-w-full table-auto border-collapse">
              <thead>
                <tr className="bg-indigo-600 text-white text-xs sm:text-sm uppercase tracking-wide">
                  <th className="p-2 sm:p-3 text-center rounded-tl-lg">S.No</th>
